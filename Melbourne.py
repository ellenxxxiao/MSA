...
Simulates and sends real-time data for an ice cream shop during summer.
"""
import random
import time
import threading
...
CONNECTION_STRING = "HostName=MSA-cloud2.azure-devices.net;DeviceId=Melbourne;SharedAccessKey=UbpQWFOBKNeh/axuHZMrvcARkntA6aqSDO9NnVBwox4="
...
INTERVAL = 1
TEMPERATURE = random.randrange(14, 20)
    ...
    try:
        ...
        while True:
            ...
            if LOWER_BOUND <= start <= UPPER_BOUND:
                bonus += TIME_BONUS
            customerEnter = random.randint(0, 8) + bonus
